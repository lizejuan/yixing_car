...
<div id="carousel-of-product"  class="carousel-of-product carousel slide1" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="carousel carouselImage" src="img/lunbo/1.jpg" width="1200" height="500" >
    </div>
    <div class="item">
      <img  class="carouselImage" src="img/lunbo/2.jpg" width="1200" height="500">
    </div>
    <div class="item">
		<img  class="carouselImage" src="img/lunbo/3.jpg" width="1180" height="500">
    </div>

    <div class="item">
        <img  class="carouselImage" src="img/lunbo/4.jpg" width="1200" height="500" >
    </div>
